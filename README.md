...
- 📱 Developed a web-based real-time chat application
- 🧠 Deeply interested in **System Design** & **Backend Architecture**
- 🔐 Growing focus on **Networking** and **Cybersecurity**
- ⚡ I love turning complex problems into clean, working systems
...
`Python` `Network Analysis` `Machine Learning`

🏪 **[Store Smart Manager](#)**  
Full-featured inventory management system for a fruits & vegetables shop, streamlining order tracking, reducing manual errors, and optimizing stock levels.  
`Java` `Full Stack Development`

⚡ **[Performance Booster](#)**  
Java application that automatically detects and removes unused files, helping users reclaim disk space effortlessly.  
`Java` `File Management`

🎮 **[Space Invaders](#)**  
Classic arcade game built with Python & OOP principles — exhibited at MEPEXPO'24.  
`Python` `Game Development` `OOP`
...
<p align="center">
  <i>⭐ "Building systems that think, automate, and scale."</i>
</p>
